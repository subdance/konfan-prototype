  ...
  export default {
    data(){
      return{
        ...
        nowMcPic: require('../assets/character_intro/mc1.png'),
        backMcPic: [
          require('../assets/character_intro/mc1.png'),
          require('../assets/character_intro/mc2.png'),
          require('../assets/character_intro/mc3.png'),
